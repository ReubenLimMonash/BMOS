...
## Auto Start
```
sudo cp /home/reuben/BMOS/scripts/10-bmos.sh /etc/profile.d
...
## Key Mappings
Keys are mapped in the /home/reuben/BMOS/bmo.txt file.
...
Example:
```
Z:system:/home/reuben/BMOS/scripts/waveleft.sh
```
